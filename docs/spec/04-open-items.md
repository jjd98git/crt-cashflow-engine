...
| 6 | Residual +0.01 to +0.03 (model longer) on some CER > 0 WAL cells in the scratch replication with the A2 credit-event convention. | **Superseded 2026-09-07 by Q21**: the engine showed 12/336 cells outside ±0.02; A2/A3 revised (credit events and prepayments in full both on the beginning-of-month balance, simultaneous; survivors amortize) and the engine ties 336/336 and 96/96. Was: keep A2 as adopted; escalate with the per-cell table if the engine shows a cell outside ±0.02; test the §5 item-7 alternatives only then. | A2, A3 (revised 2026-09-07) | Q17 → Q21 | 96 cells checked: 60 exact, 33 at ±0.01, 2 at +0.02, 1 at +0.03 (pre-Q21 replication). |
